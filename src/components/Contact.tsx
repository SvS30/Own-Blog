      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className={`rounded-lg p-8 h-full transition-colors ${
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button 
                    ...
                    className={`px-6 py-3 bg-emerald-500 text-white font-medium rounded-lg transition-all transform hover:translate-y-[-2px] hover:bg-emerald-600 flex items-center justify-center ${
