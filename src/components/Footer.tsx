  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center border-b border-slate-200 dark:border-slate-700 pb-8 mb-8">
          <div className="mb-6 md:mb-0">
            ...
            <p className={`mt-2 max-w-md transition-colors ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>
          ...
          <div className="flex flex-col items-center md:items-end">
            <button
              onClick={scrollToTop}
              className={`p-3 rounded-full mb-4 transition-all transform hover:translate-y-[-5px] ${
                darkMode 
